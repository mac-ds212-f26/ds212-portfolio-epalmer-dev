...
```{r}
weather_data <- readr::read_csv('/Users/elizapalmer/Documents/GitHub/ds212-portfolio-epalmer-dev/ica/data/weather.csv')
```
...
```{r}
write_csv(weather_data2, file = "data/processed/weather_clean.csv")
```
